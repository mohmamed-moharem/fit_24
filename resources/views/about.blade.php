    ...
    <div class="page-header breadcrumb-wrap">
        <div class="container">
            <div class="breadcrumb d-flex">
                ...
                <ion-icon name="chevron-forward-outline" style="margin-top: 4px;"></ion-icon> About us
            </div>
        </div>
    </div>
                ...
                <div class="col-md-6 col-lg-4">
                    <div class="hero-card box-shadow-outer-6 wow fadeIn animated mb-30 hover-up d-flex">
                        <div class="hero-card-icon icon-left-2 hover-up ">
                            <img class="btn-shadow-brand hover-up border-radius-5 bg-brand-muted" style="max-width: 65px;" src="assets/imgs/page/avatar-1.jpg" alt="">
                        </div>
                        <div class="pl-30">
                            ...
                            <p class="text-grey-3"> {{ $review->content }} </p>
                        </div>
                    </div>
                </div>
                @endforeach
            ...
            <div class="row">
                <div class="col-xl-8 col-lg-10 m-auto">
                    <div class="contact-from-area padding-20-row-col wow FadeInUp">
                        <h3 class="mb-10 text-center">Add Review</h3>
                        <form class="contact-form-style text-center" id="contact-form" action=" {{ route('about.store') }} " method="POST">
                            @csrf
                            <div class="row">
